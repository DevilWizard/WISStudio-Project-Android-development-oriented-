package com.wisstudio.devilwizard.photobrowserapp.download;
...
public class ImageDownLoader {
    ...
    public ImageDownLoader() {
        ...
        if (!file.exists()) {
            ...
            Log.d(TAG, "ImageDownLoader: is file maked? -- " + isMaked);
        }
    }
...
//        }
        ...
        if (ImageLoader.isNetworkConnected(MyApplication.getContext())) {
            HttpRequest.loadBitmapFromWeb(url, new HttpCallBackListener<Bitmap>() {
                ...
                public void onFinish(Bitmap response) {
                    ...
                    MainActivity.getMainActivity().runOnUiThread(() -> Toast.makeText(MyApplication.getContext(), "图片已保存", Toast.LENGTH_SHORT).show());
                    //不能在ui线程外toast
                }
